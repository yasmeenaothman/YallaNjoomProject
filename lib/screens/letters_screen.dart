...
//               itemBuilder: (context, index) => GestureDetector(
//                 onTap: () {
//                   provider.setSelectedLanguage(DummyData.dummyData.letters[index]);
//                   provider.selectedLanguage.isLocked?null:
//                   AppRouter.router.pushNamedWithReplacementFunction(
//                       LetterCardScreen.routeName);
//                 },
//                 child: DefaultStackWidget(
//                   imagePath: provider.examples.firstWhere((element) => provider.letters[index].id_example==element.id).img1, // 1_flower.png for number
//                   btn: DefaultElevatedButton(
//                     onPressed: () {
//                       provider.setSelectedLanguage(DummyData.dummyData.letters[index]);
//                       provider.selectedLanguage.isLocked?null:
